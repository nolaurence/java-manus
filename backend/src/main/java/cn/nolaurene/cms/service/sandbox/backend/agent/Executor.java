...
public class Executor {
    ...
    public String executeStep(LlmClient llmClient, List<Step> completedSteps, String goal, String step, String tools, AgentContext agentContext) throws IOException {
        ...
        // Add real-time context information
        String runtimeContext = agentContext != null ? agentContext.renderForPrompt() : "";
